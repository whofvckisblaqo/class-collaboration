...
export default function ProfessionalContact() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <header className="relative bg-gradient-to-b from-slate-200 via-slate-50 to-white pt-20 pb-12 px-6">
        <div className="max-w-7xl mx-auto text-center" data-aos="fade-down">
          <span className="inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-[0.2em] uppercase text-blue-700 bg-blue-50 rounded-full">
            Available Worldwide
          </span>
          <h1 className="text-4xl md:text-7xl font-bold tracking-tight text-blue-950 mb-6">
            Let's connect.
          </h1>
      ...
      <main className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6" data-aos="fade-right">
            ...
            {/* Main Office Card */}
            <div className="p-8 bg-blue-950 text-white rounded-[2rem] shadow-2xl transition-all hover:scale-[1.01]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-6 bg-slate-50 border border-slate-100 rounded-[1.5rem] flex flex-col items-center text-center">
          ...
          <div className="lg:col-span-7" data-aos="fade-left" data-aos-delay="200">
            <div className="bg-white p-8 md:p-12 rounded-[2rem] border border-slate-200 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)]">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <input required type="text" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-blue-900 transition-all outline-none" placeholder="John Smith" />
                    </div>
                    <div className="space-y-3">
                      <label className="text-sm font-bold text-slate-400 uppercase tracking-widest ml-1">Email Address</label>
                      <input required type="email" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-blue-900 transition-all outline-none" placeholder="john@company.com" />
                    </div>
                  </div>

                  <div className="space-y-3">
                    <label className="text-sm font-bold text-slate-400 uppercase tracking-widest ml-1">Service Required</label>
                    <select className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-blue-900 transition-all outline-none appearance-none">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea required rows={5} className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-blue-900 transition-all outline-none resize-none" placeholder="Describe your vision or challenge..."></textarea>
                  </div>

                  <button type="submit" className="w-full bg-blue-950 hover:bg-blue-800 text-white font-bold py-5 rounded-2xl flex items-center justify-center gap-4 transition-all hover:shadow-xl hover:shadow-blue-200 active:scale-[0.98]">
                    Deliver Message
                    <Send size={20} />
                  </button>
                </form>
